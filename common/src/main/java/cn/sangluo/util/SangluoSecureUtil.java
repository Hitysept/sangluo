...
/**
 * @ClassName SangluoSecureUtil
 * @Description 密码加密
 * @Author 月痕江离
 * @Date 2023/5/28 19:59
 * @Version 1.0
 */
public class SangluoSecureUtil {
    private SangluoSecureUtil() {
    }
     ...
     * @return 加密后的字符串
     */
    public static String md5(String strArgs) {
        String str = (strArgs == null ? "" : strArgs);
        ...
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12111);
        }
    }
     ...
     * @return 加密后的字符串
     */
    public static String sha1(String strArgs) {
        try {
            String str = (strArgs == null ? "" : strArgs);
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12112);
        }
    }
     ...
     * @return 加密后的字符串
     */
    public static String sha256(String strArgs) {
        try {
            String str = strArgs == null ? "" : strArgs;
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12113);
        }
    }
    ...
    public static String aesEncrypt(String key, String text) {
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12114);
        }
    }
    ...
    public static String aesDecrypt(String key, String text) {
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12115);
        }
    }
    ...
    public static String rsaEncryptByPublic(String publicKeyString, String content) {
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12116);
        }
    }
    ...
    public static String rsaEncryptByPrivate(String privateKeyString, String content) {
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12117);
        }
    }
    ...
    public static String rsaDecryptByPublic(String publicKeyString, String content) {
        ...
        try {
            ...
            return getRSAString(content, cipher, splitLength);
        } catch (Exception e) {
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12118);
        }
    }
    ...
    public static String rsaDecryptByPrivate(String privateKeyString, String content) {
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12119);
        }
    }
     ...
     */
    private static String getRSAString(String content, Cipher cipher, int splitLength) throws IllegalBlockSizeException, BadPaddingException {
    ...
    /** 根据公钥字符串获取 公钥对象 */
    private static PublicKey getPublicKeyFromString(String keyArgs)
            throws NoSuchAlgorithmException, InvalidKeySpecException {

        // 过滤掉\r\n
        String key = keyArgs.replace("\r\n", "");
    ...
    /** 根据私钥字符串获取 私钥对象 */
    private static PrivateKey getPrivateKeyFromString(String keyArgs)
            throws NoSuchAlgorithmException, InvalidKeySpecException {
