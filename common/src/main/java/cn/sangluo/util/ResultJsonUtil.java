...
public class ResultJsonUtil<T> implements Serializable {
    ...
    public ResultJsonUtil<T> success(T data){
     ...
     * @param data 数据
     */
    public ResultJsonUtil<T> customized(int code,String msg,T data){
        this.code       = code;
        this.msg        = msg;
        this.data       = null;
        return this;
     ...
     * @return 返回失败的状态
     */
    public ResultJsonUtil<T> fail(String errorMsg){
    ...
    private String getResultJson() {
        ...
        return JSON.toJSONString(jsonObject, JSONWriter.Feature.ReferenceDetection);
    }
}
