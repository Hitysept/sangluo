 ...
 * @Version 1.0
 */
public class SangluoFoxUtil {
    private SangluoFoxUtil() {
    }

    /**
     * 打印 Sa-Token 版本字符画
     */
    public static void printSangluo() {
        String str = ""
                + "                               _                     "
                + "                              | |                    "
     ...
     * @return 请求地址
     */
    public static  final  String getUrlRequestMappingStr(String url) {
        String currentUrlStrs = url;
        int length = currentUrlStrs.indexOf("?");
        length = length>0?length:currentUrlStrs.length();
        String DomainStr= currentUrlStrs.substring(0, length);
        int startIndex = DomainStr.indexOf("//")+2;
        String NoHttpStr = DomainStr.substring(startIndex,DomainStr.length());
        return NoHttpStr.substring(NoHttpStr.indexOf("/"),NoHttpStr.length());
    }
    ...
    public static String encodeUrl(String url) {
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12103);
        }
    }
    ...
    public static String decoderUrl(String url) {
        try {
            ...
            throw new SangluoExcetion(e).setCode(SangluoErrorCodeConstant.CODE_12104);
        }
    }
